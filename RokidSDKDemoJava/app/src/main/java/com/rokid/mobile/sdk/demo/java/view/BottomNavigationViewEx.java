...
//        System.out.println("mMenuView:" + mMenuView + " mButtons:" + mButtons + " mOnClickListener" + mOnClickListener);
    ...
    public void setOnNavigationItemSelectedListener(@Nullable OnNavigationItemSelectedListener listener) {
        // if not set up with com.rokid.mobile.sdk.demo.java.view pager, the same with father
...
//            Log.d("onNavigationItemSelecte", "position:"  + position);
            ...
            if (null != listener) {
                ...
                // if the selected is invalid, no need change the com.rokid.mobile.sdk.demo.java.view pager
                if (!bool)
                    return false;
            }

            // change com.rokid.mobile.sdk.demo.java.view pager
